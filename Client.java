...
public class Client
{
    ...
    public static AtomicInteger rw_violations = new AtomicInteger(0);
    public static AtomicInteger rd_violations = new AtomicInteger(0);
    public static volatile PrintWriter fwriter;
    public static volatile PrintWriter fsmall;
    
    public static volatile Hashtable<String, Long> readTimes = new Hashtable<String, Long>();
    public static volatile Hashtable<String, Long> writeTimes = new Hashtable<String, Long>();
  ...
  public static final String MAX_EXECUTION_TIME = "maxexecutiontime";
	...
	public static void main(String[] args)
	{
     ...
     //       fwriter = new PrintWriter("log", "UTF-8");
            
             fwriter = new PrintWriter("violations", "UTF-8");
            fsmall = new PrintWriter("smalllog", "UTF-8");
      ...
      terminator.interrupt();
		...
		} catch (IOException e)
		{
			...
			System.exit(-1);
               ...
               Client.fwriter.println("RW violation" + Client.rw_violations);
               Client.fwriter.println("MR violation" + Client.rd_violations);
               Client.fwriter.println("threadcount" + threadcount);
